		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Simple tutorial on data binding",
									"targetURL": "#comsapui5tutorial-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapui5tutorial-display": {
								"semanticObject": "comsapui5tutorial",
								"action": "display",
								"description": "Simple tutorial on data binding",
								"title": "Simple tutorial on data binding",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.ui5tutorial",
									"url": sap.ui.require.toUrl("com/sap/ui5tutorial")
								}
							}
						}
					}
